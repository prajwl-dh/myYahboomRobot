...
//Note : Pwm 8 is front left backwards , Pwm 9 is front left forwards
//Note : Pwm 11 is front right backwards , Pwm 10 is front right forwards
//Note : Pwm 0 is back left backwards , Pwm 1 is back left forwards
//Note : Pwm 2 is back right forwards , Pwm 3 is back right backwards
...
void run(int Speed)
{
  //This is for the front two wheels
    pwm.setPWM(8, 0, 0);
    pwm.setPWM(9, 0, Speed);
    pwm.setPWM(11, 0, 0);
    pwm.setPWM(10, 0, Speed);

  //This is for the back two wheels
    pwm.setPWM(0, 0, 0);
